...
interface MakersNameUploadComponentProps {
  makersEmail: string;
}

const MakersNameUploadComponent: React.FC<MakersNameUploadComponentProps> = ({
  makersEmail,
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        `${Config.API_URL_PAPAYATEST}/makers/name`,
        {
          email: email,
          name: name,
        },
...
export default MakersNameUploadComponent;
